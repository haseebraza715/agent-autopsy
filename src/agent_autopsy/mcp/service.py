...
from agent_autopsy.advanced import (
    LiveTraceMonitor,
...
from agent_autopsy.ingestion import TraceNormalizer, TraceParser
from agent_autopsy.output import FixSuggestionGenerator, ReportGenerator
from agent_autopsy.plugins import get_plugin_manager
from agent_autopsy.preanalysis import PatternType
from agent_autopsy.schema import Trace, TraceEvent
from agent_autopsy.tracing import get_trace_config
...
def analyze_trace(
    ...
    if deterministic_only:
        ...
        try:
            from agent_autopsy.analysis.llm_agent import run_analysis as run_llm_analysis

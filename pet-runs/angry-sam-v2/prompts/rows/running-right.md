Create one horizontal animation strip for Codex pet `angry-sam`, state `running-right`.
...
Identity: same pet in every frame: Preserve the exact existing pixel-art chibi identity: angry dark-haired humanoid, olive jacket over black shirt, dark pants, black-and-white shoes, thick eyebrows and clenched expression.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
Style: Pet-safe sprite: compact full-body mascot, readable in a 192x208 cell, clear silhouette, simple face, stable palette/materials, and crisp edges for chroma-key extraction. Style `pixel`: Pixel-art-adjacent digital mascot with a chunky silhouette, simple dark outline, limited palette, flat cel shading, and visible stepped edges. User style notes: Match the existing low-resolution pixel-art rendering, palette, outlines, anatomy, clothing, and facial proportions exactly..
